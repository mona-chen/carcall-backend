...
class Validator {
  ...
  require(
    ...
    } else if (minLength !== null && this.data[field]?.length < minLength) {
      this.errors.push(
        `${field} must be at least ${minLength} characters long`
      );
    } else if (maxLength !== null && this.data[field]?.length > maxLength) {
      this.errors.push(
  ...
  email(
    field: string,
    message: string = `${field} is not a valid email`
  ): this {
  ...
  maxLength(
    field: string,
    length: number,
    message: string = `${field} cannot exceed ${length} characters`
  ): this {
    if (
      typeof this.data[field] !== "string" ||
      this.data[field].length > length
  ...
  phone(
    field: string,
    message: string = `${field} is not a valid phone number`
  ): this {
  ...
  password(
    field: string,
    message: string = `${field} does not meet password criteria`
  ): this {
  ...
  number(field: string, message: string = `${field} must be a number`): this {
  ...
  minValue(
    field: string,
    minValue: number,
    message: string = `${field} must be greater than or equal to ${minValue}`
  ): this {
  ...
  maxValue(
    field: string,
    maxValue: number,
    message: string = `${field} must be less than or equal to ${maxValue}`
  ): this {
